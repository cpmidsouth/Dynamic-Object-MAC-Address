#!/bin/bash
# Version 1 for Dynamic MAC - Original dynam_obj_upd goes to Nuno Sousa & CB Currier
# Date 06/20/2018 12:14:00 CST

## EDIT THE BELOW OPTIONS FOR YOUR NEEDS ##
IP_LIST=/home/admin/dynobj/ip_list.txt
MAC_LIST=/home/admin/dynobj/mac_list.txt
timeout=300
...
then
	...
	do
        arp -n |grep $I | awk '{print $1}' >> $IP_LIST
	done
else
	for I in $(cat $MAC_LIST)
	do
